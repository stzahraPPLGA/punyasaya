...
<body>
    ...
    <div class="font-semibold mx-auto">
        ...
        <button class="w-full h-12 px-6 bg-gray-200 text-indigo-100 transition-colors duration-150 bg-indigo-700 rounded-lg focus:shadow-outline hover:bg-indigo-800">Large block button</button>
            ...
            {{-- Greeting 
            <div class="my-2 mr-10 col-1 flex justify-center items-center rounded bg-slate-400 shadow-md">
                <img src="">
            ...
            {{-- Kelas 10 & 11 
            <div class="mr-10 my-5 text-center">
            ...
            {{-- Kelas 12 & 13 
            <div class="mr-10 my-5 text-center cursor-pointer">
                <div class="p-4 rounded bg-red-400">
                    <p>KELAS 12</p>
                </div>
                <div class="p-4 mt-4 rounded bg-sky-400">
